...
namespace StudentEmploymentPortal.ViewModels.StudentApplicationViewModels
{
    public class PartialStudentApplicationViewModel
    {
        ...
        public StudentApplication.EnumStudentApplicationStatus SelectedStudentApplicationStatus { get; set; }
        ...
        public IEnumerable<SelectListItem> OutcomeOptions => GetEnumSelectList<StudentApplication.EnumStudentApplicationStatus>();
